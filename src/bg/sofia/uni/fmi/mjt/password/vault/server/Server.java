...
import bg.sofia.uni.fmi.mjt.password.vault.storage.FileStorage;
...
public class Server {
    ...
    public static void main(String[] args) {
        Server server = new Server(7777, new CommandExecutor(new FileStorage()));
        server.start();
    }
                    ...
                    while (keyIterator.hasNext()) {
                        ...
                        if (key.isReadable()) {
                            ...
                            if (clientInput.equals("disconnect")) {
                                writeClientOutput(clientChannel, "Disconnected");
                                clientChannel.close();
                                continue;
                            }

                            String output = commandExecutor
                                    .execute(CommandCreator.newCommand(clientInput, key.hashCode()));
